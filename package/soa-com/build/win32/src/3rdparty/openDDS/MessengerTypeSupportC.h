...
namespace Messenger
{
  ...
  // TAO_IDL - Generated from
  // D:\Work\ZZYT\DDS\OpenDDS\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_sequence\sequence_ch.cpp:99

  typedef ::TAO::DCPS::ZeroCopyDataSeq< Messenger::Message, DCPS_ZERO_COPY_SEQ_DEFAULT_SIZE> MessageSeq;
  

  // TAO_IDL - Generated from
  // D:\Work\ZZYT\DDS\OpenDDS\ACE_wrappers\TAO\TAO_IDL\be\be_interface.cpp:748
...
#define _MESSENGER_MESSAGETYPESUPPORT__VAR_OUT_CH_
  ...
  // TAO_IDL - Generated from
  // D:\Work\ZZYT\DDS\OpenDDS\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_interface\interface_ch.cpp:40

  class openDDS_Export MessageTypeSupport
  ...
  public:
    ...
    // TAO_IDL - Generated from
    // D:\Work\ZZYT\DDS\OpenDDS\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_interface\interface_ch.cpp:137
...
#define _MESSENGER_MESSAGEDATAWRITER__VAR_OUT_CH_
  ...
  class openDDS_Export MessageDataWriter
...
#define _MESSENGER_MESSAGEDATAREADER__VAR_OUT_CH_
  ...
  class openDDS_Export MessageDataReader
...
#define _MESSENGER_MESSAGETYPESUPPORT__TRAITS_
  ...
  template<>
  struct openDDS_Export Objref_Traits< ::Messenger::MessageTypeSupport>
  {
    static ::Messenger::MessageTypeSupport_ptr duplicate (
        ::Messenger::MessageTypeSupport_ptr p);
    static void release (
        ::Messenger::MessageTypeSupport_ptr p);
    static ::Messenger::MessageTypeSupport_ptr nil ();
...
#define _MESSENGER_MESSAGEDATAWRITER__TRAITS_
  ...
  template<>
  struct openDDS_Export Objref_Traits< ::Messenger::MessageDataWriter>
  {
    static ::Messenger::MessageDataWriter_ptr duplicate (
        ::Messenger::MessageDataWriter_ptr p);
    static void release (
        ::Messenger::MessageDataWriter_ptr p);
    static ::Messenger::MessageDataWriter_ptr nil ();
    static ::CORBA::Boolean marshal (
...
#define _MESSENGER_MESSAGEDATAREADER__TRAITS_
  ...
  template<>
  struct openDDS_Export Objref_Traits< ::Messenger::MessageDataReader>
  {
    static ::Messenger::MessageDataReader_ptr duplicate (
        ::Messenger::MessageDataReader_ptr p);
    static void release (
        ::Messenger::MessageDataReader_ptr p);
    static ::Messenger::MessageDataReader_ptr nil ();
    static ::CORBA::Boolean marshal (
