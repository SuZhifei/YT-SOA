...
set_target_properties(CommonAPI PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libCommonAPI.so.3.1.10"
  IMPORTED_SONAME_RELEASE "libCommonAPI.so.3.1.10"
  )

list(APPEND _IMPORT_CHECK_TARGETS CommonAPI )
list(APPEND _IMPORT_CHECK_FILES_FOR_CommonAPI "${_IMPORT_PREFIX}/lib/libCommonAPI.so.3.1.10" )
