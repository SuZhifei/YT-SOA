...
set_target_properties(CommonAPI-SomeIP PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libCommonAPI-SomeIP.so.3.1.10"
  IMPORTED_SONAME_RELEASE "libCommonAPI-SomeIP.so.3.1.10"
  )

list(APPEND _IMPORT_CHECK_TARGETS CommonAPI-SomeIP )
list(APPEND _IMPORT_CHECK_FILES_FOR_CommonAPI-SomeIP "${_IMPORT_PREFIX}/lib/libCommonAPI-SomeIP.so.3.1.10" )
